...
epsilonInitial    = 250 #epsilon is the distance to check for neighbours
epsilonFinal    = 201 #epsilon is the distance to check for neighbours
epsilonIncrement   = 50 #epsilon is the distance to check for neighbours
kInitial         = 2 #k is the number on the epsilon-neighborhood criterion
kFinal         = 9 #k is the number on the epsilon-neighborhood criterion

file       = 'Data/20irr2d_1024.dat' #File to be read
plot = True #Plot?
plotNearestNeighbour = True #Plot lines to epsilon-neighbours?
save = True #save as image?
...
for epsilon in range(epsilonInitial,epsilonFinal,epsilonIncrement):
    for k in range(kInitial,kFinal):
        print("Making plot for eps:" + str(epsilon) + " k:" + str(k))
        #Ids
        center = []
        outlier = []
        candidates = []
